...
if __name__ == "__main__":
    ...
    df_parsed = pd.read_csv("../data/model_apply_outputs/parsed_files_val/route_"+str(k)+".txt")
    
    df_1=pd.DataFrame(None)
    df_1 = pd.read_csv("../data/model_apply_outputs/df_routes_files_val/df_"+str(k)+".csv", na_values=na_values, keep_default_na=False)
    
    travel_times = pd.read_csv("../data/model_apply_outputs/travel_times_files_val/travel_times_route_"+str(k)+".csv", na_values=na_values, keep_default_na=False)
    ...
    while(multiple_skips <= 20):
        try:
            ...
            stored_values = []
            with open("../data/model_apply_outputs/local_optima_analisis/solution_route_"+str(k)+"_it_"+str(w), 'r') as read_obj:
            ...
            #df_results.at[i, 'zones_order'] = [zones_order]
    ...
    df_results.to_csv("../data/model_apply_outputs/df_local_optima_analisis/df_results_prob_route_"+str(k)+".csv")
