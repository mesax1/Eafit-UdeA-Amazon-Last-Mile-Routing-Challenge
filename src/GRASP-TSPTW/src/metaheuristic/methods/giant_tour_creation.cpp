...
TSPGiantTour::TSPGiantTour()
        : giant_tour_solution(*new TSPSolution())
{
}
...
TSPSolution* TSPGiantTour::run(const TSPInstance& instance, int randomization /*= 3*/)
{
}
...
TSPSolution* TSP_GiantTour_FN::run(const TSPInstance& instance, int randomization /*= 3*/)
{

    int n_vehicles = 1;

    TSPSolution* solution = new TSPSolution(instance, n_vehicles);
    ...
    while(customers_without_route > 0) {
        ...
        TSPCustomer* current_c = solution->vehicles[vehicle_id]->customers.back();
...
TSPSolution* TSPGiantTour_Prob_RNN::run(const TSPInstance& instance, int randomization)
{
