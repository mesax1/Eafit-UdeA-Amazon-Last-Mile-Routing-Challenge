...
TSPSolution* TSPNeighborhood::search_neighbors(TSPSolution* initial_solution, const TSPInstance& instance, bool  by_zones)
{
}
...
TSPSolution* TSPSwapNeighborhood::search_neighbors(TSPSolution* initial_solution, const TSPInstance& instance, bool  by_zones)
{
 ...
 */
TSPSolution* TSPSwapNeighborhood::apply_best_move(TSPSolution* initial_solution, vector<int>& best_move, const TSPInstance& instance)
{
    if(best_move.size() != 0) {
        TSPSolution* local_optima = initial_solution;
        ...
        if(vehicle_one_id == vehicle_two_id) {
            TSPCustomer* customer_one = local_optima->vehicles[vehicle_one_id]->customers[customer_one_id];
            TSPCustomer* customer_two = local_optima->vehicles[vehicle_two_id]->customers[customer_two_id];
...
TSPSolution* TSPRelocateNeighborhood::search_neighbors(TSPSolution* initial_solution, const TSPInstance& instance, bool  by_zones)
{
    int n_vehicles = initial_solution->vehicles.size();
 ...
 *          if there's no local optima, returns initial_solution instead
 */
TSPSolution* TSPRelocateNeighborhood::apply_best_move(TSPSolution* initial_solution, vector<int>& best_move, const TSPInstance& instance)
{
    if(best_move.size() != 0) {
        TSPSolution* local_optima = initial_solution;
        int vehicle_one_id = best_move[0];
...
TSPSolution* TSP_ProbZoneSwapNeighborhood::search_neighbors(TSPSolution* initial_solution, const TSPInstance& instance, bool  by_zones)
{
    int n_vehicles = initial_solution->vehicles.size();
    TSPVehicle temporal_vehicle(instance.n_cust, instance.Q);
    TSPSolution* temporal_solution = new TSPSolution(instance, n_vehicles);
    float min_delta = 0.0;
    vector<int> best_move;
    vector<int> move;
    TSPVehicle vehicle_one(instance.n_cust, instance.Q);
 ...
 *          if there's no local optima, returns initial_solution instead
 */
TSPSolution* TSP_ProbZoneSwapNeighborhood::apply_best_move(TSPSolution* initial_solution, vector<int>& best_move, const TSPInstance& instance)
{
    ...
    if(best_move.size() != 0) {
        ...
        vector<TSPCustomer*> aux_vector_1 = {};
        vector<TSPCustomer*> aux_vector_2 = {};
        vector<TSPCustomer*> aux_vector_3 = {};
        vector<TSPCustomer*> aux_vector_4 = {};
        vector<TSPCustomer*> aux_vector_5 = {};
        vector<TSPCustomer*> complete_vehicle = {};
...
TSPSolution* TSP_ProbZoneRelocateNeighborhood::search_neighbors(TSPSolution* initial_solution, const TSPInstance& instance, bool  by_zones)
{
    int n_vehicles = initial_solution->vehicles.size();
    TSPVehicle temporal_vehicle(instance.n_cust, instance.Q);
    TSPSolution* temporal_solution = new TSPSolution(instance, n_vehicles);
 ...
 *          if there's no local optima, returns initial_solution instead
 */
TSPSolution* TSP_ProbZoneRelocateNeighborhood::apply_best_move(TSPSolution* initial_solution, vector<int>& best_move, const TSPInstance& instance)
{
